...
export const servicesData = [
  ...
  export const mobileAppPagedata = {
    section1: {
      ...
      description:
        "We build high-performance mobile applications for iOS and Android using native and cross-platform technologies. Our apps are designed to be sleek, efficient, and user-friendly.",
      cta: "See Our Apps",
    },
    section2: {
      ...
      services: [
        {
          ...
          description: "Native apps built with Swift and Kotlin.",
        },
        {
          title: "Cross-Platform Apps",
          description: "Flutter and React Native for faster delivery.",
        },
        {
          title: "UI/UX for Mobile",
          description: "Mobile-optimized designs for better engagement.",
        },
        {
          title: "App Store Deployment",
          description: "Submission and optimization for app stores.",
        },
        {
          title: "Backend Integration",
          description:
            "Connect your app to custom APIs or third-party services.",
        },
        {
          title: "Maintenance & Updates",
          description: "Post-launch support and performance tuning.",
        },
      ],
    },
    section3: {
      ...
      technologies: [
        {
          ...
          description: "Fast UI toolkit from Google",
        },
        {
          name: "React Native",
          icon: "/service/mobileApp/react.svg",
          description: "Reusable React-based mobile development",
        },
        {
          name: "Kotlin",
        ...
        },
        {
          ...
          description: "Powerful iOS programming language",
        },
        {
          name: "Firebase",
          icon: "/service/mobileApp/firebase.svg",
          description: "Realtime database and hosting",
        },
      ],
    },
    section4: {
